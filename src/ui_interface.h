 ...
 */
extern void NotifyAddressBookChanged(CWallet *wallet, const std::string &address, const std::string &label, EntryStatus status);

/* Wallet transaction added, removed or updated.
 * Note: called with lock cs_wallet held.
 */
extern void NotifyTransactionChanged(CWallet *wallet, const uint256 &hashTx, EntryStatus status);
 ...
 */
extern void NotifyAlertChanged(const uint256 &hash, EntryStatus status);
