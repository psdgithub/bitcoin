...
{
    BOOST_CHECK_MESSAGE(NewThread(ThreadOne, NULL), "NewThread Failed!");
    BOOST_CHECK_MESSAGE(NewThread(ThreadTwo, NULL), "NewThread Failed!");
    Sleep(750);
    BOOST_CHECK_MESSAGE(fThreadOneDone, "NewThread doesn't create thread or LOCK/SHARED_LOCK deadlocks.");
    BOOST_CHECK_MESSAGE(fThreadTwoDone, "NewThread doesn't create thread or LOCK/SHARED_LOCK deadlocks.");
}
