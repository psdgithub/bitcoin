...
public:
    ...
    bool AddKeyPubKey(const CKey& key, const CPubKey &pubkey, int64_t nCreateTime = 0);
    ...
    bool AddCryptedKey(const CPubKey &vchPubKey, const std::vector<unsigned char> &vchCryptedSecret, int64_t nCreateTime = 0);
