...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (mapArgs.count("-proxy"))
    {
        ...
        if (nSocksVersion == 4)
        {
            // disable outgoing Tor and IPv6 connections if not already disabled or set explicitly
    ...
    {
        uiInterface.InitMessage(_("Importing blockchain data file.  This operation may take several hours."));
    ...
    if (filesystem::exists(pathBootstrap)) {
        uiInterface.InitMessage(_("Importing bootstrap blockchain data file.  This operation may take several hours."));
